    ...
    assert.are.same({
      {
        ...
        tags = {'OFFICE'},
        original_time = first_heading.dates[1],
        time = first_heading.dates[1]:apply_repeater_until(time),
        type = 'DEADLINE',
      ...
      },
      {
        ...
        time = third_heading.dates[1]:with_negative_adjustment(),
        minutes = 10,
        type = 'DEADLINE',
